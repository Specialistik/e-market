...
function initAutocomplete() {
  ...
  autocomplete_bottom = new google.maps.places.Autocomplete(
      /** @type {!HTMLInputElement} */(document.getElementById('autocomplete_bottom')),
      {types: ['geocode']});

  // When the user selects an address from the dropdown, populate the address
  // fields in the form.
  autocomplete.addListener('place_changed', fillInAddress);
  autocomplete_bottom.addListener('place_changed', fillInAddressBottom);
}
...
function geolocateBottom() {
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function(position) {
      ...
      autocomplete_bottom.setBounds(circle.getBounds());
    });
  }
}
